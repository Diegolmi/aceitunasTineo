  ...
  useEffect(() => {
    ...
    <Navbar.Collapse id="responsive-navbar-nav">
      <Nav className="ml-auto">
        <Nav.Link href="#inicio" className="link-nav">Inicio</Nav.Link>
        ...
        <NavDropdown className="link-nav" title="Productos" id="collasible-nav-dropdown">
          <NavDropdown.Item className="link-nav" href="#action/3.1">Action</NavDropdown.Item>
          <NavDropdown.Item className="link-nav" href="#action/3.2">Another action</NavDropdown.Item>
          <NavDropdown.Item className="link-nav" href="#action/3.3">Something</NavDropdown.Item>
        </NavDropdown>
